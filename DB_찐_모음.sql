...
CREATE TABLE Seat (
    seat_number_row char(1) not null,
    seat_number_col char(2) not null,
    theater_name char(10) not null,
    cinema_id int unsigned not null,
    type_seat char(5) not null default '일반',
    CONSTRAINT PK_Seat PRIMARY KEY(seat_number_row, seat_number_col,theater_name,cinema_id),
...
CREATE TABLE Schedule_seat (
    ...
    CONSTRAINT PK_Schedule_seat PRIMARY KEY(movie_time, theater_name, cinema_id, movie_id, seat_number_row, seat_number_col, ticket_id),
    ...
    REFERENCES Movie_schedule(movie_id) ON UPDATE CASCADE ON DELETE RESTRICT,
    CONSTRAINT FK_Schedule_seat_5 FOREIGN KEY(seat_number_row)
    REFERENCES Seat(seat_number_row) ON UPDATE CASCADE ON DELETE RESTRICT,
    CONSTRAINT FK_Schedule_seat_5 FOREIGN KEY(seat_number_col)
    REFERENCES Seat(seat_number_col) ON UPDATE CASCADE ON DELETE RESTRICT,
...
insert into Seat values
  ...
  ("J", "04", "1관", 1000000, "커플석"),
  ("J", "05", "1관", 1000000, "커플석"),
  ("A", "01", "1관", 1000000, "장애인석"),
  ("A", "02", "1관", 1000000, "장애인석"),
  ("A", "03", "1관", 1000000, "장애인석"),
  ("A", "04", "1관", 1000000, "장애인석"),
  ("A", "05", "1관", 1000000, "장애인석"),
  ("C", "01", "1관", 1000000, "일반석"),
  ("C", "02", "1관", 1000000, "일반석"),
  ("C", "03", "1관", 1000000, "일반석"),
  ("C", "04", "1관", 1000000, "일반석"),
  ...
  ("J", "04", "3관", 1000000, "커플석"),
  ("J", "05", "3관", 1000000, "커플석"),
  ("A", "01", "3관", 1000000, "장애인석"),
  ("A", "02", "3관", 1000000, "장애인석"),
  ("A", "03", "3관", 1000000, "장애인석"),
  ("A", "04", "3관", 1000000, "장애인석"),
  ("A", "05", "3관", 1000000, "장애인석"),
  ("C", "01", "3관", 1000000, "일반석"),
  ("C", "02", "3관", 1000000, "일반석"),
  ("C", "03", "3관", 1000000, "일반석"),
  ("C", "04", "3관", 1000000, "일반석"),
  ...
  ("G", "09", "2관", 1000002, "일반석"),
  ("G", "10", "2관", 1000002, "일반석"),
  ("A", "01", "VIP관", 1000000, "특별석"),
  ("A", "02", "VIP관", 1000000, "특별석"),
  ("A", "03", "VIP관", 1000000, "특별석"),
  ("A", "04", "VIP관", 1000000, "특별석"),
  ("A", "05", "VIP관", 1000000, "특별석"),
  ("A", "06", "VIP관", 1000000, "특별석"),
  ("A", "07", "VIP관", 1000000, "특별석"),
  ("A", "08", "VIP관", 1000000, "특별석"),
  ("A", "09", "VIP관", 1000000, "특별석"),
  ("A", "10", "VIP관", 1000000, "특별석"),
  ("B", "01", "2관", 1000001, "일반석"),
  ("B", "02", "2관", 1000001, "일반석"),
  ("B", "03", "2관", 1000001, "일반석"),
  ("B", "04", "2관", 1000001, "일반석"),
